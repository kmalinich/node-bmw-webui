			...
			<form class="form-horizontal" name="form-lcm" id="form-lcm" action="javascript:form_lcm();">
				...
				<div class="card-group">
					<div class="card" id="card-lcm-front">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-front">Front</a></h5>
					...
					<div class="card" id="card-lcm-rear">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-rear">Rear</a></h5>
				...
				<div class="card-group">
					<div class="card" id="card-lcm-led">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-led">LEDs</a></h5>
				...
				<div class="card-group">
					<div class="card" id="card-lcm-clamps">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-clamps">Clamps</a></h5>
					...
					<div class="card" id="card-lcm-modes">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-modes">Modes</a></h5>
					...
					<div class="card" id="card-lcm-inputs">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-inputs">Inputs</a></h5>
					...
					<div class="card" id="card-lcm-switches">
						<div class="card-body">
							<h5 class="card-title text-center"><a data-toggle="collapse" href="#collapse-lcm-switches">Switches</a></h5>
				...
				<button class="btn btn-raised btn-block btn-lg btn-primary" id="form-lcm-submit" type="submit">Send</button>
